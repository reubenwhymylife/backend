...
exports.getFreeSubscriptions = exports.deleteSubscription = exports.editSubscription = exports.adminGetUserSubscriptions = exports.getUserSubscriptions = exports.getSubsciptions = exports.subscriptionControler = void 0;
...
const adminGetUserSubscriptions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const sessionId = req.query.userId;
    const response = yield (0, Subscription_service_1.adminGetUserSubService)(sessionId);
    return res.status(200).success({
        message: CustomReasons_1.Reasons.customedReasons.DATA_RETRIEVED,
        data: response,
    });
...
const getFreeSubscriptions = (Req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield (0, Subscription_service_1.freeSubscriptionService)();
    return res.status(200).success({
        message: CustomReasons_1.Reasons.customedReasons.DATA_RETRIEVED,
        data: response,
    });
});
exports.getFreeSubscriptions = getFreeSubscriptions;
