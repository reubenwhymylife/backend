...
subscriptionRouter.get("/admin-user-subscription", Subscription_controler_1.adminGetUserSubscriptions);
...
subscriptionRouter.get("/get-freeSubscription", Subscription_controler_1.getFreeSubscriptions);
exports.default = {
